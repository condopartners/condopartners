...
- Conventional commits: `feat:`, `fix:`, `docs:`, `chore:`, `refactor:`, `test:`, `ci:` (English prefix; body may be pt-BR).
...
- Fill `.github/pull_request_template.md` completely (template is **pt-BR**). Link the issue. Note the spec path.
